<?php $user = require('api/getUser.php'); ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<main class="bg-white max-w-xl rounded shadow my-8 sm:mx-8 lg:mx-auto px-4 py-8">
  ...
  <h4 class="text-lg text-gray-800 border-b border-gray-300 pb-2 mb-4">Update User</h4>

  <section>

    <form class="grid grid-cols-1 gap-4" action="api/updateUser.php?id=<?= $user['id'] ?>" method="POST">
      ...
      <div class="form-group">
        <label>Age: </label>
        <input class="form-input" type="number" name="age" value="<?= $user['age'] ?>"/>
      </div>
      <div class="form-group">
        <label>Gender: </label>
